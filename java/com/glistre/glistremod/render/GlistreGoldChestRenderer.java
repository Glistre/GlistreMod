...
public class GlistreGoldChestRenderer extends TileEntitySpecialRenderer
{

	private static ResourceLocation largeChestTexture = new ResourceLocation(Reference.MODID + ":" + "textures/blocks/glistre_large_chest_gold.png");
	private static ResourceLocation chestTexture = new ResourceLocation(Reference.MODID + ":" + "textures/blocks/glistre_chest_gold.png");

    private ModelChest modelchest = new ModelChest();
    private ModelChest largeModelChest = new ModelLargeChest();
    private boolean isChristmas;

    public GlistreGoldChestRenderer(RenderManager renderManager)
    {
    ...
    public void renderTileEntityAt(TileEntityGlistreChestGold te, double posX, double posY, double posZ, float partialTicks, int destroyStage)
    {
       int i;
        ...
        else
        {
            ...
            if (block instanceof GlistreChestGold && i == 0)
            {
                try
                {
                ((GlistreChestGold)block).checkForSurroundingChests(te.getWorld(), te.getPos(), te.getWorld().getBlockState(te.getPos()));
              }
	...
	public void renderTileEntityAt(TileEntity te, double posX, double posZ, double p_180535_6_,
			...
			this.renderTileEntityAt((TileEntityGlistreChestGold)te, posX, posZ, p_180535_6_, p_180535_8_, p_180535_9_);
	}
