...
public class GlistreChestGoldInventoryRenderer extends TileEntityItemStackRenderer {
...
//    private final TileEntityChest chestGlistre = new TileEntityGlistreChest();
...
//Your custom block
        if (block == BlockRegistry.glistre_chest_gold) {
...
//			TileEntityRendererDispatcher.instance.renderTileEntityAt(itemRenders.get(0), 0.0D, 0.0D, 0.0D, 0.0F);
        ...
        }else if  (block == BlockRegistry.glistre_chest) {
