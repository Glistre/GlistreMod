...
public class BlockTobyKingFire extends BlockFire
{
    ...
    {
        if (!worldIn.getBlockState(pos.down()).isSideSolid(worldIn, pos.down(), EnumFacing.UP) && !((BlockFire) BlockRegistry.light_toby_king_fire).canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
    ...
    public static void init()
    {
        ...
        ((BlockFire) BlockRegistry.light_toby_king_fire).setFireInfo(Blocks.ACACIA_STAIRS, 5, 20);
        ((BlockFire) BlockRegistry.light_toby_king_fire).setFireInfo(Blocks.DARK_OAK_STAIRS, 5, 20);
