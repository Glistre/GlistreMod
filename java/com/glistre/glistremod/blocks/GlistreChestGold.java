...
public class GlistreChestGold extends BlockChest
{
    ...
    public GlistreChestGold(BlockChest.Type type)
    {
        super(type);
        this.setDefaultState(this.blockState.getBaseState().withProperty(FACING, EnumFacing.NORTH));
        this.chestType = type;
        this.setCreativeTab(type == BlockChest.Type.TRAP ? CreativeTabs.REDSTONE : CreativeTabs.DECORATIONS);
    }
