...
{
	//1.10.2 eliminated FLIP and ALT state
    ...
    {
        if (!worldIn.getBlockState(pos.down()).isSideSolid(worldIn, pos.down(), EnumFacing.UP) && !((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
    ...
    public static void init()
    {
        ...
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.ACACIA_STAIRS, 5, 20);
        ((BlockFire) BlockRegistry.light_fire).setFireInfo(Blocks.DARK_OAK_STAIRS, 5, 20);
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        ...
        if (!worldIn.getBlockState(pos.down()).isSideSolid(worldIn, pos.down(), EnumFacing.UP) && !((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
            ...
            if (((BlockFire) BlockRegistry.light_fire).canCatchFire(worldIn, pos.south(), EnumFacing.NORTH))
            {
