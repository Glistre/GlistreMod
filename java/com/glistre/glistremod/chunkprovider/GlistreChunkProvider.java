package com.glistre.glistremod.chunkprovider;
...
public class GlistreChunkProvider implements IChunkGenerator
{
    ...
    public GlistreChunkProvider(World worldIn, boolean mapFeaturesEnabledIn, long seed, String dimension)
    {
        {
        ...
        if (dimension != null)
        {
            this.settings = ChunkProviderSettings.Factory.jsonToFactory(dimension).build();
