...
public class TileEntityGlistreChestGold extends TileEntityChest
{
...
/*    public TileEntityGlistreChestGold()
    {
        this.cachedChestType = -1;
    }*/

    @SideOnly(Side.CLIENT)
    public TileEntityGlistreChestGold(BlockChest.Type chestType)
    {
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound nbt)
    {
        ...
        {
            nbt.setString("Golden Chest", this.customName);
        }
...
@Override    
    ...
    protected TileEntityGlistreChestGold getAdjacentChest(EnumFacing side)
    {
        ...
        if (this.isChestAt(blockpos))
        {
            ...
            if (tileentity instanceof TileEntityGlistreChestGold)
            {
                TileEntityGlistreChestGold tileentitychest = (TileEntityGlistreChestGold)tileentity;
...
/*    protected TileEntityChest func_174911_a(EnumFacing p_174911_1_)
    ...
    private boolean isChestAt(BlockPos p_174912_1_)
    {
        ...
        else
        {
            ...
            return block instanceof GlistreChestGold && ((BlockChest)block).chestType == this.getChestType();
        }
    }
