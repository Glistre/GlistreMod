...
import com.glistre.glistremod.init.VillagerRegistry;

public class GlistreVillagePieces
{
    public static void registerVillagePieces()
    {
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.House1.class, "ViBH");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.Field1.class, "ViDF");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.Field2.class, "ViF");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.Torch.class, "ViL");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.Hall.class, "ViPH");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.House4Garden.class, "ViSH");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.WoodHut.class, "ViSmH");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.Church.class, "ViST");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.House2.class, "ViS");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.Start.class, "ViStart");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.Path.class, "ViSR");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.House3.class, "ViTRH");
        MapGenStructureIO.registerStructureComponent(GlistreVillagePieces.Well.class, "ViW");
    }

    public static List<GlistreVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)//this line is diff in 1.8.9 but no error shown
    {
    	////List<PieceWeight> list = Lists.<GlistreVillagePieces.PieceWeight>newArrayList();
    	////List<GlistreVillagePieces.PieceWeight> list = Lists.<GlistreVillagePieces.PieceWeight>newArrayList();

    //	List<net.minecraft.world.gen.structure.StructureVillagePieces.PieceWeight> list = Lists.<GlistreVillagePieces.PieceWeight>newArrayList();
    	List list = Lists.newArrayList();//1.8.9 version works
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.House4Garden.class, 4, MathHelper.getRandomIntegerInRange(random, 2 + size, 4 + size * 2)));
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.Church.class, 20, MathHelper.getRandomIntegerInRange(random, 0 + size, 1 + size)));
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.House1.class, 20, MathHelper.getRandomIntegerInRange(random, 0 + size, 2 + size)));
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.WoodHut.class, 3, MathHelper.getRandomIntegerInRange(random, 2 + size, 5 + size * 3)));
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.Hall.class, 15, MathHelper.getRandomIntegerInRange(random, 0 + size, 2 + size)));
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.Field1.class, 3, MathHelper.getRandomIntegerInRange(random, 1 + size, 4 + size)));
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.Field2.class, 3, MathHelper.getRandomIntegerInRange(random, 2 + size, 4 + size * 2)));
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.House2.class, 15, MathHelper.getRandomIntegerInRange(random, 0, 1 + size)));
        list.add(new GlistreVillagePieces.PieceWeight(GlistreVillagePieces.House3.class, 8, MathHelper.getRandomIntegerInRange(random, 0 + size, 3 + size * 2)));
        net.minecraftforge.fml.common.registry.VillagerRegistry.addExtraVillageComponents(list, random, size);
        Iterator<GlistreVillagePieces.PieceWeight> iterator = list.iterator();

        while (iterator.hasNext())
        {
            if (((GlistreVillagePieces.PieceWeight)iterator.next()).villagePiecesLimit == 0)
            {
                iterator.remove();
            }
        }
    ...
    private static int updatePieceWeight(List<GlistreVillagePieces.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (GlistreVillagePieces.PieceWeight GlistreVillagePieces$pieceweight : p_75079_0_)
        {
            if (GlistreVillagePieces$pieceweight.villagePiecesLimit > 0 && GlistreVillagePieces$pieceweight.villagePiecesSpawned < GlistreVillagePieces$pieceweight.villagePiecesLimit)
            {
                flag = true;
            }

            i += GlistreVillagePieces$pieceweight.villagePieceWeight;
        }

        return flag ? i : -1;
    }

    private static GlistreVillagePieces.Village findAndCreateComponentFactory(GlistreVillagePieces.Start start, GlistreVillagePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends GlistreVillagePieces.Village > oclass = weight.villagePieceClass;
        Object GlistreVillagePieces$village = null;

        if (oclass == GlistreVillagePieces.House4Garden.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GlistreVillagePieces.Church.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GlistreVillagePieces.House1.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GlistreVillagePieces.WoodHut.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GlistreVillagePieces.Hall.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GlistreVillagePieces.Field1.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GlistreVillagePieces.Field2.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GlistreVillagePieces.House2.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == GlistreVillagePieces.House3.class)
        {
            GlistreVillagePieces$village = GlistreVillagePieces.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else
        {
         //   GlistreVillagePieces$village = net.minecraftforge.fml.common.registry.VillagerRegistry.getVillageComponent(weight, start , structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        	GlistreVillagePieces$village = VillagerRegistry.getVillageComponent(weight, start , structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }

        return (Village) GlistreVillagePieces$village;
    }

    private static GlistreVillagePieces.Village generateComponent(GlistreVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (GlistreVillagePieces.PieceWeight GlistreVillagePieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    k -= GlistreVillagePieces$pieceweight.villagePieceWeight;

                    if (k < 0)
                    {
                        if (!GlistreVillagePieces$pieceweight.canSpawnMoreVillagePiecesOfType(componentType) || GlistreVillagePieces$pieceweight == start.structVillagePieceWeight && start.structureVillageWeightedPieceList.size() > 1)
                        {
                            break;
                        }

                        GlistreVillagePieces.Village GlistreVillagePieces$village = findAndCreateComponentFactory(start, GlistreVillagePieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);

                        if (GlistreVillagePieces$village != null)
                        {
                            ++GlistreVillagePieces$pieceweight.villagePiecesSpawned;
                            start.structVillagePieceWeight = GlistreVillagePieces$pieceweight;

                            if (!GlistreVillagePieces$pieceweight.canSpawnMoreVillagePieces())
                            {
                                start.structureVillageWeightedPieceList.remove(GlistreVillagePieces$pieceweight);
                            }

                            return GlistreVillagePieces$village;
                        }
                    }
                }
            }

            StructureBoundingBox structureboundingbox = GlistreVillagePieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new GlistreVillagePieces.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(GlistreVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureComponent generateAndAddRoadPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = GlistreVillagePieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new GlistreVillagePieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public static class Church extends GlistreVillagePieces.Village
        {
            public Church()
            {
            }

            public Church(GlistreVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static GlistreVillagePieces.Church createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new GlistreVillagePieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate = BlockRegistry.silver_ore_1.getDefaultState();
    ...
    public static class Field1 extends GlistreVillagePieces.Village
        {
            ...
            public Field1(GlistreVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GlistreVillagePieces.Field1 createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new GlistreVillagePieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field2 extends GlistreVillagePieces.Village
        {
            /** First crop type for this field. */
            private Block cropTypeA;
            /** Second crop type for this field. */
            ...
            public Field2(GlistreVillagePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
            {
            ...
            public static GlistreVillagePieces.Field2 createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new GlistreVillagePieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Hall extends GlistreVillagePieces.Village
        {
            public Hall()
            {
            }

            public Hall(GlistreVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GlistreVillagePieces.Hall createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new GlistreVillagePieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate = this.getBiomeSpecificBlockState(BlockRegistry.silver_ore_1.getDefaultState());
    ...
    public static class House1 extends GlistreVillagePieces.Village
        {
            public House1()
            {
            }

            public House1(GlistreVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GlistreVillagePieces.House1 createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new GlistreVillagePieces.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House2 extends GlistreVillagePieces.Village
        {
            ...
            public House2(GlistreVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GlistreVillagePieces.House2 createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new GlistreVillagePieces.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House3 extends GlistreVillagePieces.Village
        {
            public House3()
            {
            }

            public House3(GlistreVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GlistreVillagePieces.House3 createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new GlistreVillagePieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House4Garden extends GlistreVillagePieces.Village
        {
            ...
            public House4Garden(GlistreVillagePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static GlistreVillagePieces.House4Garden createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new GlistreVillagePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
            }
    ...
    public static class Path extends GlistreVillagePieces.Road
        {
            private int length;
            ...
            public Path(GlistreVillagePieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
            {
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                ...
                {
                    StructureComponent structurecomponent = this.getNextComponentNN((GlistreVillagePieces.Start)componentIn, listIn, rand, 0, i);
                ...
                {
                    StructureComponent structurecomponent1 = this.getNextComponentPP((GlistreVillagePieces.Start)componentIn, listIn, rand, 0, j);
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                            break;
                        case SOUTH:
                            GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                            break;
                        case WEST:
                            GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                            break;
                        case EAST:
                            GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
                ...
                if (flag && rand.nextInt(3) > 0 && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                            break;
                        case SOUTH:
                            GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                            break;
                        case WEST:
                            GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                            break;
                        case EAST:
                            GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            }

            public static StructureBoundingBox findPieceBox(GlistreVillagePieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
            {
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate3 = this.getBiomeSpecificBlockState(BlockRegistry.silver_ore_1.getDefaultState());
    ...
    public static class PieceWeight
        {
            public Class <? extends GlistreVillagePieces.Village > villagePieceClass;
            public final int villagePieceWeight;
            public int villagePiecesSpawned;
            public int villagePiecesLimit;

            public PieceWeight(Class <? extends GlistreVillagePieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
            {
    ...
    public abstract static class Road extends GlistreVillagePieces.Village
        {
            public Road()
            {
            }

            protected Road(GlistreVillagePieces.Start start, int type)
            {
                super(start, type);
            }
        }

    public static class Start extends GlistreVillagePieces.Well
        {
            public BiomeProvider worldChunkMngr;
            /** World terrain type, 0 for normal, 1 for flap map */
            public int terrainType;
            public GlistreVillagePieces.PieceWeight structVillagePieceWeight;
            public List<GlistreVillagePieces.PieceWeight> structureVillageWeightedPieceList;
            ...
            public Start(BiomeProvider chunkManagerIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<GlistreVillagePieces.PieceWeight> p_i2104_6_, int p_i2104_7_)
            {
                super((GlistreVillagePieces.Start)null, 0, rand, p_i2104_4_, p_i2104_5_);
    ...
    public static class Torch extends GlistreVillagePieces.Village
        {
            public Torch()
            {
            }

            public Torch(GlistreVillagePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
            {
            ...
            public static StructureBoundingBox findPieceBox(GlistreVillagePieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
            {
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            protected GlistreVillagePieces.Start startPiece;

            public Village()
            {
            }

            protected Village(GlistreVillagePieces.Start start, int type)
            {
                super(type);
             ...
             */
            protected StructureComponent getNextComponentNN(GlistreVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return GlistreVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case SOUTH:
                            return GlistreVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case WEST:
                            return GlistreVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        case EAST:
                            return GlistreVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
             ...
             * Gets the next village component, with the bounding box shifted +1 in the X and Z direction.
             */
            protected StructureComponent getNextComponentPP(GlistreVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return GlistreVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case SOUTH:
                            return GlistreVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case WEST:
                            return GlistreVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        case EAST:
                            return GlistreVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
    ...
    public static class Well extends GlistreVillagePieces.Village
        {
            public Well()
            {
            }

            public Well(GlistreVillagePieces.Start start, int type, Random rand, int x, int z)
            {
                super(start, type);
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
                GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
                GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                GlistreVillagePieces.generateAndAddRoadPiece((GlistreVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                for (int i = 0; i <= 5; ++i)
                {
                    for (int j = 0; j <= 5; ++j)
                    {
                        if (j == 0 || j == 5 || i == 0 || i == 5)
                        {
                            this.setBlockState(worldIn, BlockRegistry.silver_ore_1.getDefaultState(), j, 11, i, structureBoundingBoxIn);
    ...
    public static class WoodHut extends GlistreVillagePieces.Village
        {
            ...
            public WoodHut(GlistreVillagePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static GlistreVillagePieces.WoodHut createPiece(GlistreVillagePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new GlistreVillagePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
