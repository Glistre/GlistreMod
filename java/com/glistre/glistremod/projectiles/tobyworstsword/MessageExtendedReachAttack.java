      ...
      IMessage> 
{
          ...
          MessageContext ctx) 
    {
        ...
        final EntityPlayerMP thePlayer = (EntityPlayerMP)GlistreMod.proxy.getPlayerEntityFromContext(ctx);
//1.10.2 changed #getServerForPlayer to #getServerWorld(EntityPlayer)
        thePlayer.getServerWorld().addScheduledTask(
              new Runnable()
              {
                  ...
                  public void run() 
                  {
                      ...
                      //1.10.2 replaced #getHeldItemMainhand with either #getHeldItemMainhand or #getHeldItemOffhand
