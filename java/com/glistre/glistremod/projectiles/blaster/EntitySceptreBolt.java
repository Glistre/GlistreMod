...
public abstract class EntitySceptreBolt extends EntityArrow
{
	 private static final Predicate<Entity> ARROW_TARGETS = Predicates.and(new Predicate[] {EntitySelectors.NOT_SPECTATING, EntitySelectors.IS_ALIVE, new Predicate<Entity>()
	    ...
	    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntitySceptreBolt.class, DataSerializers.BYTE);
	    private int xTile;
	    private int yTile;
	    private int zTile;
	    ...
	    public EntitySceptreBolt.PickupStatus pickupStatus;
	    ...
	    public EntitySceptreBolt(World worldIn)
	    {
	        ...
	        this.yTile = -1;
	        this.zTile = -1;
	        this.pickupStatus = EntitySceptreBolt.PickupStatus.DISALLOWED;
	        this.damage = 2.0D;
	    ...
	    public EntitySceptreBolt(World worldIn, EntityLivingBase shooter)
	    {
	        ...
	        {
	            this.pickupStatus = EntitySceptreBolt.PickupStatus.ALLOWED;
	        }
	    }
	    ...
	    protected void onHit(RayTraceResult raytraceResultIn)
	    {
	        ...
	        if (entity != null)
	        {
	            ...
	            else
	            {
	                ...
	                {
	                    if (this.pickupStatus == EntitySceptreBolt.PickupStatus.ALLOWED)
	                    {
	    ...
	    public void readEntityFromNBT(NBTTagCompound compound)
	    {
	        ...
	        {
	            this.pickupStatus = EntitySceptreBolt.PickupStatus.getByOrdinal(compound.getByte("pickup"));
	        }
	        else if (compound.hasKey("player", 99))
	        {
	            this.pickupStatus = compound.getBoolean("player") ? EntitySceptreBolt.PickupStatus.ALLOWED : EntitySceptreBolt.PickupStatus.DISALLOWED;
	        }
	    }
	    ...
	    public void onCollideWithPlayer(EntityPlayer entityIn)
	    {
	        ...
	        {
	            boolean flag = this.pickupStatus == EntitySceptreBolt.PickupStatus.ALLOWED || this.pickupStatus == EntitySceptreBolt.PickupStatus.CREATIVE_ONLY && entityIn.capabilities.isCreativeMode;

	            if (this.pickupStatus == EntitySceptreBolt.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack()))
	            {
	                flag = false;
	            }
	    ...
	    public static enum PickupStatus
	    {
	        ...
	        public static EntitySceptreBolt.PickupStatus getByOrdinal(int ordinal)
	        {
