...
//        this.getYOffset();
 ...
 //           this.getYOffset();
    ...
    public EntityBlasterBolt(World worldIn, EntityLivingBase entityliving, float shadow)
    {
        super(worldIn);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = entityliving;
...
//        this.getYOffset();
        ...
        this.setThrowableHeading(this.motionX, this.motionY, this.motionZ, shadow * 1.5F, 1.0F);
    }
